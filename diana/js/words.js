 ...
 export let wordsRus1 = ['булавка', 'считать', 'дуть', 'приспосабливать', 'отвращение', 'власть', 'удар', 'сравнение', 'соглашение', 'пробка',
     'развлечение', 'туман', 'луч', 'награда', 'изобретение', 'взрыв', 'попытка', 'кривая', 'песок', 'уловка',
     'ценность', 'стих', 'шерсть', 'замысел', 'разговор', 'вкус', 'поток', 'хлопать', 'ласты'];

 export let wordsEng1 = ['pin', 'account', 'blow', 'adjust', 'disgust', 'grip', 'kick', 'comparison', 'agreement', 'cork',
     'amusement', 'mist', 'ray', 'reward', 'invention', 'burst', 'attempt', 'curve', 'sand', 'trick',
     'value', 'verse', 'wool', 'scheme', 'talk', 'taste', 'split', 'clap', 'flippers' ];
 ...
 export let wordsRus2 = ['замок', 'треугольник', 'провод', 'парик', 'мыло', 'закат', 'созвездие', 'мел', 'кошелёк', 'грабитель',
     ...
     'избегать', 'счет', 'процветающий', 'брать взаймы', 'брэнд', 'ломать', 'взятка', 'подсчитывать', 'размер оплаты', 'проверять' ];
 ...
 export let wordsRus4 = ['нанимать', 'работник', 'работодатель', 'поощрять', 'запрос', 'оборудование', 'основывать', 'оценивать', 'обмен', 'объяснение',
